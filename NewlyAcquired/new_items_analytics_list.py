...
def get_record_ids(result_node,id_list):
   ...
   for this_row in rows:
      try:
          ...
          sys.stderr.write("couldn't find Column0."+"\n")
          return id_list,outcome
   return id_list,0
