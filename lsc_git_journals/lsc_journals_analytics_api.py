...
def get_item_info(result_node,id_list):
   ...
   for this_row in rows:
      ...
      try:
          this_node=this_row.find("Column10")
          oclc_no = str(this_node.text)
      except:
          sys.stderr.write("couldn't find Column10."+"\n")
      item_row=str(issn)
      id_list.append(item_row + "|" + material_type + "|" + mms_id + "|" + title + "|" + norm_call_no + "|" + call_no + "|" + library + "|" + collection + "|" + description + "|" + oclc_no)
   return id_list,0
